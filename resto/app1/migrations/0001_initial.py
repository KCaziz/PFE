    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resto_name', models.CharField(max_length=100)),
                ('menu', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='products', to='app1.menu')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
        ...
        migrations.AddField(
            model_name='menu',
            name='restaurant',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='menus', to='app1.restaurant'),
        ),
        migrations.CreateModel(
            name='Cart',
            fields=[
